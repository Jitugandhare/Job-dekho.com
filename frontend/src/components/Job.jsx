...
const Job = ({ job }) => {
    ...
    const daysAgo = useMemo(() => {
        if (!job?.createdAt) return null; // Handle case where createdAt is undefined
    ...
    return (
        <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100'>
            ...
            <div className='flex items-center gap-2 my-2'>
                <Button className="p-6" variant="outline" size="icon" aria-label={`Company logo for ${job?.company?.name}`}>
                    <Avatar>
