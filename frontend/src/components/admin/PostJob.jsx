...
const PostJob = () => {
    ...
    const validateInputs = () => {
        ...
        if (input.position <= 0) newErrors.position = 'Position should be at least 1';
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                className="focus-visible:ring-offset-0 focus-visible:ring-0 my-1"
                            />
                            {errors.salary && <p className='text-red-600 text-xs'>{errors.salary}</p>}
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                className="focus-visible:ring-offset-0 focus-visible:ring-0 my-1"
                            />
                            {errors.jobType && <p className='text-red-600 text-xs'>{errors.jobType}</p>}
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <Input
                                ...
                                className="focus-visible:ring-offset-0 focus-visible:ring-0 my-1"
                            />
                            {errors.position && <p className='text-red-600 text-xs'>{errors.position}</p>}
                        </div>
                        {
                            companies.length > 0 && (
                        ...
                        {errors.companyId && <p className='text-red-600 text-xs'>{errors.companyId}</p>}
                    </div>
                    {
                        loading ? (
